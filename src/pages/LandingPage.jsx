...
function LandingPage() {
  return (
    <div className="w-screen h-screen bg-[url('/bg.jpeg')] bg-cover bg-no-repeat bg-center flex items-center justify-center">
      <div class="absolute inset-0 bg-black bg-opacity-90"></div>
      <div class="relative z-10 p-4 flex flex-col justify-center items-center">
        <div className=" text-white poppins-semibold text-[40px] py-5">
        ...
        <div className="flex flex-row items-center gap-2 justify-center text-[20px] poppins-regular">
          ...
          <a href="https://www.linkedin.com/in/praveen-prasad-14764b231/">
            <IoLogoLinkedin className="text-white text-[25px]" />
          </a>
        </div>
      </div>
    </div>
